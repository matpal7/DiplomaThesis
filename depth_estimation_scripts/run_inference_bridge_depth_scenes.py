...
def main() -> None:
    ...
    scene_dir_main = root_dir / "datasets" / f"dataset_{args.date}" / "downstream_task"
    out_dir_main =  root_dir / "out" / f"out_{args.date}" / "pose_estimation" / "depth_nn"
    ...
    for scene in scenes:
        img_dir = scene_dir_main / scene / "rgb"
        out_dir = out_dir_main / scene
