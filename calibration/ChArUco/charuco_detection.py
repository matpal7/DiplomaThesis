...
def detect_charuco_in_image(img_path, board, aruco_detector):
...
def collect_charuco_detections(image_paths, board, aruco_detector):
    all_charuco_corners = []
    all_charuco_ids = []
    image_size = None
...
def main():
    ...
    calibrate_camera_from_images(
        left_images,
        out_dir,file_name="left_calib.npy"
    )
