...
if __name__ == '__main__':
    ...
    depth_dir = os.path.join(dataset_dir, 'cameras_downstream_task')
    print(depth_dir)

    # out_dir = parent_dir / "out" / f"out_{date}" / "cameras_downstream_task"
    ...
    save_repeated_scene_captures(1,1, frame_size_stereo=stereo_frame_size, save_dir=depth_dir, use_realsense=False, use_zed=True, calib_dict=None,
                          squares_horizontally=6,
                          squares_vertically=8,
                          squares_length=45.0,
                          marker_length=31.0
